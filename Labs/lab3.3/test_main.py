...
from DAL.file_manipulation import serialize_to_file, deserialize_from_file, clear_file
...
def main() -> int:
    ...
    # Binary part ------------------------------------------
    serialize_to_file(students, BINARY_FILENAME, mode="binary")
    deserialized_students_bin: list[Student] | tuple[Student, ...] = deserialize_from_file(BINARY_FILENAME, mode="binary")
    print_students(deserialized_students_bin)

    # XML part ------------------------------------------
    serialize_to_file(students, "XML_FILENAME", mode="xml")
